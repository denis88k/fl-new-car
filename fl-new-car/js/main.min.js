...
(0,_components_modal_js__WEBPACK_IMPORTED_MODULE_0__["default"])('.promo__header-modal-payment', '.modal-payment', '.close-icon');
(0,_components_modal_js__WEBPACK_IMPORTED_MODULE_0__["default"])('.promo__header-modal-tradIn', '.modal-tradIn', '.close-icon');
...
const modal = (btnOpen, modal, btnClose) => {
  btnOpen = document.querySelector(btnOpen), modal = document.querySelector(modal), btnClose = document.querySelector(btnClose);
