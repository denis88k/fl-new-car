...
var E = (p, b, g) => (b in p ? _(p, b, { enumerable: !0, configurable: !0, writable: !0, value: g }) : (p[b] = g)),
  L = (p, b) => {
...
(function (p, b) {
  typeof exports == 'object' && typeof module != 'undefined'
    ...
    ? define(b)
    : ((p = typeof globalThis != 'undefined' ? globalThis : p || self), (p.JustValidate = b()));
})(this, function () {
  'use strict';
  const p =
  ...
  class O {
          ...
          this.validate().finally(() => {
            ...
            this.globalConfig.lockForm && this.unlockForm(),
              this.isValid
                ...
                : (s = this.onFailCallback) == null || s.call(this, this.fields);
          });
      });
    ...
    getLocalisedString(e) {
      ...
      return !this.currentLocale || !this.dictLocale.length
        ? e
        : ((s = this.dictLocale.find(i => i.key === e)) == null ? void 0 : s.dict[this.currentLocale]) || e;
    }
    getFieldErrorMessage(e, t) {
      const s =
        typeof e.errorMessage == 'function' ? e.errorMessage(this.getElemValue(t), this.fields) : e.errorMessage;
    ...
    setFieldValid(e, t) {
      (this.fields[e].isValid = !0),
        t !== void 0 && (this.fields[e].successMessage = this.getFieldSuccessMessage(t, this.fields[e].elem));
    }
    setGroupInvalid(e, t) {
    ...
    validateGroupRule(e, t, s, i) {
      switch (i.rule) {
        case y.Required:
          (t === 'radio' || t === 'checkbox') &&
            (s.every(r => !r.checked) ? this.setGroupInvalid(e, i) : this.setGroupValid(e, i));
      }
    }
        ...
        case d.Files: {
          ...
          const o = (c, h) => {
            const f = Number.isFinite(h.minSize) && c.size < h.minSize,
              ...
              D =
                Array.isArray(h.extensions) && !h.extensions.includes(c.name.split('.')[c.name.split('.').length - 1]),
    ...
    validateField(e, t, s = !1) {
      ...
      return (
        ...
        t.isValid && this.setFieldValid(e, (r = t.config) == null ? void 0 : r.successMessage),
    ...
    addField(e, t, s) {
      ...
      return (
        t.forEach(r => {
          ...
          if (!r.validator && !r.plugin && (!r.rule || !Object.values(d).includes(r.rule)))
            throw Error(`Rule should be one of these types: ${Object.values(d).join(', ')}. Provided value: ${r.rule}`);
        }),
    ...
    removeField(e) {
      ...
      return (
        this.removeListener(t, this.fields[e].elem, this.handlerChange), this.clearErrors(), delete this.fields[e], this
      );
    }
    removeGroup(e) {
      ...
      for (const l in this.fields) {
        ...
        Object.keys(h).forEach(f => {
          ...
          o.elem.classList.remove(
            ((s = o.config) == null ? void 0 : s.errorFieldCssClass) || this.globalConfig.errorFieldCssClass,
            ((i = o.config) == null ? void 0 : i.successFieldCssClass) || this.globalConfig.successFieldCssClass,
          );
      }
      for (const l in this.groupFields) {
        ...
        Object.keys(c).forEach(f => {
          o.elems.forEach(m => {
            ...
            (m.style[f] = ''),
              m.classList.remove(
                ((v = o.config) == null ? void 0 : v.errorFieldCssClass) || this.globalConfig.errorFieldCssClass,
              );
          });
        });
    ...
    renderTooltip(e, t, s) {
      var f;
      const { top: i, left: r, width: a, height: l } = e.getBoundingClientRect(),
    ...
    createErrorLabelElem(e, t, s) {
      ...
      const r = this.isTooltip()
        ? s == null
          ? void 0
          : s.errorLabelStyle
        : (s == null ? void 0 : s.errorLabelStyle) || this.globalConfig.errorLabelStyle;
      return (
        Object.assign(i.style, r),
        i.classList.add(
          (s == null ? void 0 : s.errorLabelCssClass) || this.globalConfig.errorLabelCssClass,
    ...
    createSuccessLabelElem(e, t, s) {
      ...
      return (
        Object.assign(i.style, r),
        i.classList.add(
          (s == null ? void 0 : s.successLabelCssClass) || this.globalConfig.successLabelCssClass,
    ...
    renderFieldLabel(e, t) {
      ...
      if (e.type === 'checkbox' || e.type === 'radio') {
        ...
        ((i = (s = e.parentElement) == null ? void 0 : s.tagName) == null ? void 0 : i.toLowerCase()) === 'label'
          ? (a = (r = e.parentElement) == null ? void 0 : r.parentElement) == null || a.appendChild(t)
          : h
        ...
        for (const l in this.groupFields) {
          ...
          if (o.isValid) {
            o.elems.forEach(f => {
              ...
              Object.assign(
                f.style,
                ((m = o.config) == null ? void 0 : m.successFieldStyle) || this.globalConfig.successFieldStyle,
              ),
                f.classList.add(
                  ((v = o.config) == null ? void 0 : v.successFieldCssClass) || this.globalConfig.successFieldCssClass,
                );
          ...
          (this.isValid = !1),
            o.elems.forEach(h => {
              ...
              Object.assign(
                h.style,
                ((f = o.config) == null ? void 0 : f.errorFieldStyle) || this.globalConfig.errorFieldStyle,
              ),
                h.classList.add(
                  ((m = o.config) == null ? void 0 : m.errorFieldCssClass) || this.globalConfig.errorFieldCssClass,
                );
            });
            ...
            this.isTooltip() &&
              this.tooltips.push(
                this.renderTooltip(
                  o.groupElem,
                  c,
                  (t = (e = o.config) == null ? void 0 : e.tooltip) == null ? void 0 : t.position,
                ),
              );
        }
        for (const l in this.fields) {
            ...
            if (!o.asyncCheckPending) {
              ...
              h && this.renderFieldLabel(o.elem, h),
                o.elem.classList.add(
                  ((s = o.config) == null ? void 0 : s.successFieldCssClass) || this.globalConfig.successFieldCssClass,
                );
            }
            continue;
          }
          (this.isValid = !1),
            o.elem.classList.add(
              ((i = o.config) == null ? void 0 : i.errorFieldCssClass) || this.globalConfig.errorFieldCssClass,
            );
          const c = this.createErrorLabelElem(l, o.errorMessage, o.config);
            ...
            this.isTooltip() &&
              this.tooltips.push(
                this.renderTooltip(
                  o.elem,
                  c,
                  (a = (r = o.config) == null ? void 0 : r.tooltip) == null ? void 0 : a.position,
                ),
              );
        }
      }
